    ...
    def handle_contact(self, message):
        ...
        if message.contact:
            ...
            self.bot.send_message(
                ...
                "📋 Вы также можете ознакомиться с краткой информацией о наших процедурах или посетить наши страницы в социальных сетях. Выберите интересующий раздел в меню ниже. 👇",
                parse_mode="HTML"
            )
